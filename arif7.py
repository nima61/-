...
poll = LinePoll(cl)
call = cl
creator = ["uf75aedf15989f40943100dc87bb8f64a"]
owner = ["uf75aedf15989f40943100dc87bb8f64a"]
admin = ["uf75aedf15989f40943100dc87bb8f64a"]
staff = ["uf75aedf15989f40943100dc87bb8f64a"]
            ...
            if wait["ghost"] == True:
                try:
                    if op.param2 not in Bots and op.param2 not in owner and op.param2 not in admin and op.param2 not in staff:
                        ...
                        sw.inviteIntoGroup(op.param1,[mid,Amid,Bmid,Cmid,Dmid]
                        sw.leaveGroup(op.param1)
                        X = cl.getGroup(op.param1)
                        X.preventedJoinByTicket = True
                        kb.updateGroup(X)
                        kb.inviteIntoGroup(op.param1,[Emid,Zmid]
                        wait["blacklist"][op.param2] = True
            except:
                pass             
...
#-------------------------------------------------------------------------------                
        ...
        if op.type == 5:
              if wait["autoAdd"] == True:
                  ...
                  cl.sendText(op.param1, wait["message"])
                  cl.sendContact(op.param1, "ufd1fc96a20d7cf0a8e6e8dfc117f32be")
...
#KICKALL
                          ...
                          if msg._from in admin:
                           if msg.toType == 2:
                              print("ok")
                              _name = msg.text.replace("!curut","pass")
...
">>>Ⓑⓨⓔ_Ⓑⓨⓔ ⒼⒸ Ⓛⓐⓚⓝⓐⓣ>><\nⒹⓝⓓⓐⓜ Ⓒⓐⓡⓘ Ⓚⓜⓘ\n<<<<<<<<<>>\nhttps://line.me/ti/p/D")
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sw.sendMessage(msg.to, "Salken all "+str(G.name))
                                G = cl.getGroup(msg.to)
                                G.preventedJoinByTicket = True
                                cl.updateGroup(G)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                sw.sendMessage(msg.to, "Good bye "+str(G.name))
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                for m_id in Bots:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"✒ CANNIBAL bot\n\n"+ma+"\nTotal「%s」Bots" %(str(len(Bots))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✒ CANNIBAL Protection\n\n✒ PROTECT URL :\n"+ma+"\n✒ PROTECT KICK :\n"+mb+"\n✒ PROTECT JOIN :\n"+md+"\n✒ PROTECT CANCEL:\n"+mc+"\nTotal「%s」Grup yg dijaga" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectcancel))))

                        elif cmd == "ckbot" or cmd == "absen":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[PASUKAN BERSIAP].")
                                ki.sendMessage(msg.to, "╚☆Ⓢⓘⓐⓟ☆╗\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗")
                                kk.sendMessage(msg.to, "╚☆Ⓢⓘⓐⓟ☆╗\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗")
                                kc.sendMessage(msg.to, "╚☆Ⓢⓘⓐⓟ☆╗\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗")
                        ...
                        elif cmd == "ck.respon" or cmd == "respon":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                cl.sendMessage(msg.to, "[CANNIBAL™️ ].")
                                ki.sendMessage(msg.to, "╚☆Ⓢⓘⓐⓟ☆╗\n╚Ⓚⓞⓜⓐⓝⓓⓝ╮╗")
...
#===========COMMAND BLACKLIST============#
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"CANNIBAL™️ Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
                        ...
                        elif cmd == "cucianban" or text.lower() == 'cuci':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                              wait["blacklist"] = {}
                          ...
                          if wait["selfbot"] == True:
                              if settings["autoJoinTicket"] == True:
                                 ...
                                 for ticket_id in n_links:
                                     ...
                                     group6 = sw.findGroupByTicket(ticket_id)
